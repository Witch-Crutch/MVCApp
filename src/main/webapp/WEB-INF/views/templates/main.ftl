        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 links">
                    <!-- TODO: изменить на абсолютные пути-->
                    <#if user??> <a href="/profile" class="nav-link">Профиль</a>
                    <#else> <a href="/auth" class="nav-link">Вход/Регистрация</a>
                    </#if>
                </div>
    ...
    <div class="container">
        ...
        <div class="row stages-cont_img">
            ...
            <div class="offset-2 col-md-2">
                ...
                <div class="row stages-cont_text center"><h6>3. Заключение договора <span> с последующей оплатой</span>
                        после
                        услуги
                    </h6>
                </div>
            ...
            <div class="offset-2 col-md-2 text-center">
                ...
                <div class="row stages-cont_text center"><h6> 5. Оплата любым удобным <span>для вас способом</span></h6>
                </div>
            </div>
        </div>
        ...
        <div class="row stages-cont_img">
            ...
            <div class="offset-2 col-md-2">
                ...
                <div class="row stages-cont_text center"><h6><span> 4. Организация и контроль</span> всего процесса</h6>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card border-white offset-3 col-md-6" style="border-radius: 20px">
                    <div class="card-body center">
                        <div style="padding-top: 80px">
                            <input type="email" id="inputEmail" class="form-control auth-cont_input" placeholder="Почта"
                                   required>
                        </div>
